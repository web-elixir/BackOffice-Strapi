...
export interface ApiConcoursConcours extends Struct.CollectionTypeSchema {
  collectionName: 'concours';
  info: {
    description: '';
    displayName: 'Concours';
    pluralName: 'concour';
    singularName: 'concours';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    Begin: Schema.Attribute.DateTime & Schema.Attribute.Required;
    City: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Valid: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
  };
}
...
export interface ApiMaintenanceMaintenance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    Status: Schema.Attribute.Boolean & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiRewardReward extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    expired: Schema.Attribute.Boolean & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reward.reward'
...
export interface ApiScanCodeScanCode extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    inscriptionDate: Schema.Attribute.DateTime;
    ...
    participation: Schema.Attribute.Boolean;
    participationDate: Schema.Attribute.DateTime;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::concours.concours': ApiConcoursConcours;
